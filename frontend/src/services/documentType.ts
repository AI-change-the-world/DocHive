...
// 获取模板的所有文档类型
export const getDocumentTypesByTemplate = (
  templateId: number,
  includeInactive = false
) => {
  return request.get<ApiResponse<DocumentType[]>>(
    `/document-types/template/${templateId}`,
    {
...
export const updateDocumentType = (
  ...
  return request.put<ApiResponse<DocumentType>>(
    `/document-types/${docTypeId}`,
    data
  );
};
...
export const addField = (
  ...
  return request.post<ApiResponse<DocumentTypeField>>(
    `/document-types/${docTypeId}/fields`,
    {
...
export const getFields = (docTypeId: number) => {
  return request.get<ApiResponse<DocumentTypeField[]>>(
    `/document-types/${docTypeId}/fields`
  );
};
...
export const updateField = (
  fieldId: number,
  data: Partial<DocumentTypeField>
) => {
  return request.put<ApiResponse<DocumentTypeField>>(
    `/document-types/fields/${fieldId}`,
    data
  );
};
...
export const batchUpdateFields = (
  ...
  return request.put<ApiResponse<DocumentTypeField[]>>(
    `/document-types/${docTypeId}/fields/batch`,
    fields
  );
};
