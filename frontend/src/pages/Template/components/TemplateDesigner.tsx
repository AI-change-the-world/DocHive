        ...
        <Space size="small">
          ...
          <Tooltip title={record.is_doc_type ? "文档类型字段" : "设为文档类型"}>
            <Button
              ...
              onClick={() =>
                handleChange(index, "is_doc_type", !record.is_doc_type)
              }
            >
              TYPE
            </Button>
      ...
      <Form form={form} layout="vertical">
        ...
        <Collapse ghost>
          <Panel header="高级配置 - 业务属性检索" key="1">
            ...
            >
              <InfoCircleOutlined />{" "}
              提示：配置业务关键词识别Prompt后，用户搜索时系统能通过AI语义理解匹配到对应的编码
            </div>
          </Panel>
        </Collapse>
      </Form>
